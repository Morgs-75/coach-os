...
<task type="auto">
  ...
  <verify>
    <automated>deno check "C:/Users/Troy Morgan/OneDrive/coach-os/supabase/functions/cron-sms-reminders/index.ts" 2>&1 || (echo "deno not available — falling back to grep" && grep -n "use_session" "C:/Users/Troy Morgan/OneDrive/coach-os/supabase/functions/cron-sms-reminders/index.ts")</automated>
    <manual>
      ...
      3. If deno is available: `deno check supabase/functions/cron-sms-reminders/index.ts` must exit 0 with no type errors
    </manual>
  </verify>
  <done>
