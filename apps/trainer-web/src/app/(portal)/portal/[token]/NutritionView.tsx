...
function getTokens(dark: boolean): Tokens {
  ...
  return {
    pageBg: `
      radial-gradient(800px 600px at 20% 10%, rgba(255,179,74,.07), transparent 60%),
      radial-gradient(700px 500px at 80% 0%, rgba(59,130,246,.07), transparent 55%),
      radial-gradient(600px 400px at 70% 90%, rgba(74,222,128,.05), transparent 55%),
      linear-gradient(180deg, #f8fafc, #f1f5f9)
    `,
    text: "#0f172a",
    muted: "rgba(15,23,42,0.55)",
    muted2: "rgba(15,23,42,0.40)",
    border: "rgba(0,0,0,0.10)",
    cardBg: "linear-gradient(180deg, rgba(255,255,255,.98), rgba(255,255,255,.92))",
    cardShadow: "0 4px 24px rgba(0,0,0,.07)",
    mealBg: "rgba(248,250,252,0.98)",
    cellBorder: "rgba(0,0,0,0.06)",
    headerCellBg: "rgba(0,0,0,0.025)",
    totalRowBg: "rgba(0,0,0,0.025)",
    kpiBoxBg: "rgba(0,0,0,0.025)",
    macroBg: "rgba(0,0,0,0.025)",
    macroBorder: "rgba(0,0,0,0.10)",
    legendCardBg: "rgba(0,0,0,0.03)",
    legendCardBorder: "rgba(0,0,0,0.10)",
    stackBarBg: "rgba(0,0,0,0.08)",
    stackBarBorder: "rgba(0,0,0,0.10)",
    chevBg: "rgba(0,0,0,0.04)",
    pillBg: "rgba(0,0,0,0.04)",
    feedbackBtnBg: "rgba(0,0,0,0.03)",
